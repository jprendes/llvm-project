...
RISCVAsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  const static MCFixupKindInfo Infos[] = {
      ...
      {"fixup_riscv_gprel_lo12_i", 12, 20, 0},
      {"fixup_riscv_gprel_lo12_s", 0, 32, 0},
      {"fixup_riscv_gprel_add", 0, 0, 0},
      {"fixup_riscv_epic_hi20", 12, 20, 0},
      {"fixup_riscv_epic_lo12_i", 12, 20, 0},
      {"fixup_riscv_epic_lo12_s", 0, 32, 0},
      {"fixup_riscv_epic_base_add", 0, 0, 0},
