...
; RV32I-OBJ-NEXT:   bnez  a0, 0x28
; RV32I-OBJ-NEXT:   auipc a0, 256
; RV32I-OBJ-NEXT:   jr    32(a0)
; RV32I-OBJ-NEXT:   unimp
; RV32I-OBJ-NEXT:   unimp
; RV32I-OBJ-NEXT:   ...
; RV32I-OBJ-NEXT:   addi    a0, zero, 1
; RV32I-OBJ-NEXT:   ret
; RV32I-OBJ-NEXT:   unimp
; RV32I-OBJ-NEXT:   unimp
; RV32I-OBJ-NEXT:   addi    a0, zero, 1
...
; RV32IC-OBJ-NEXT:  bnez  a0, 0x24
; RV32IC-OBJ-NEXT:  auipc a0, 256
; RV32IC-OBJ-NEXT:  jr    28(a0)
; RV32IC-OBJ-NEXT:  unimp
; RV32IC-OBJ-NEXT:  unimp
; RV32IC-OBJ-NEXT:  ...
; RV32IC-OBJ-NEXT:  addi    a0, zero, 1
; RV32IC-OBJ-NEXT:  ret
; RV32IC-OBJ-NEXT:  unimp
; RV32IC-OBJ-NEXT:  unimp
; RV32IC-OBJ-NEXT:  addi    a0, zero, 1
